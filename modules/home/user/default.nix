...
in
{
  options.${namespace}.user = {
    ...
    name = mkOpt (types.nullOr types.str) (config.snowfallorg.user.name or "yash") "The user account.";
      ...
      assertions = [
        {
          ...
          message = "dots.user.name must be set";
        }
        {
          assertion = cfg.home != null;
          message = "dots.user.home must be set";
        }
      ];
