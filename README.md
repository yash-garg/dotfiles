...
- `aurora`: MacBook Pro 16" with M4 Pro chip & 48GB RAM.
- `astra`: MacBook Pro 14" with M4 Pro chip & 24GB RAM.
- `cosmos`: Raspberry Pi 5 running NixOS, hosting home services.
- `helios`: Raspberry Pi 4 running Pi-hole, Home Assistant and Miniflux.
